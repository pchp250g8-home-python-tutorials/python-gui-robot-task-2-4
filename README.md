...
The robot's field is 6 cells long and 3 cells wide. It has blue walls around the perimeter. 
...
The solution of the task is located in the file "Task-2-4.py".

RobotTask-2-4. Занятия по Python. Исполнитель Робот. Платформа StepInDev. Приложение с графическим интерфейсом пользователя.
Поле робота имеет размеры: длина 6 клеток, ширина 3 клетки. Оно миеет синие стены по периметру. 
...
У некоторых клеток есть стены справа.
...
Решение задачи находится в файле "Task-2-4.py".
